...
ms1718_male = ms1718[ms1718['RIAGENDR']==1]
ms1718_female = ms1718[ms1718['RIAGENDR']==2]
ms1718_male['BMXWAIST'] = ms1718_male['BMXWAIST'].fillna(100)
ms1718_female['BMXWAIST'] = ms1718_female['BMXWAIST'].fillna(80.5)
ms1718 = pd.merge(ms1718_female, ms1718_male, how = 'outer')
...
ms1718_male = ms1718[ms1718['RIAGENDR']==1]
ms1718_female = ms1718[ms1718['RIAGENDR']==2]
ms1718_male['LBDHDD'] = ms1718_male['LBDHDD'].fillna(44)
ms1718_female['LBDHDD'] = ms1718_female['LBDHDD'].fillna(52)

ms1718 = pd.merge(ms1718_female, ms1718_male, how = 'outer')

ms1718['BPQ040A']= ms1718['BPQ040A'].fillna(2)
ms1718['BPQ040A'] = ms1718.BPQ040A.replace({9: 2})
...
ms1718['LBXTR'] = ms1718['LBXTR'].fillna(75)

ms1718['BPQ090D'] = ms1718['BPQ090D'].fillna(2)
ms1718['BPQ090D'] = ms1718.BPQ090D.replace({9: 2})


#Presión sanguínea sistolica (116 = mode) y diastolica (68 = mode) elevada. Pastillas (req4)
#reemplazamos nulos por moda
ms1718['BPXSY1']= ms1718['BPXSY1'].fillna(116)

ms1718['BPXDI1']= ms1718['BPXDI1'].fillna(68)

ms1718['BPQ050A']= ms1718['BPQ050A'].fillna(2)
ms1718['BPQ050A'] = ms1718.BPQ050A.replace({9: 2})


#glucosa en ayunas elevada (moda 97) o pastillas para la diabetes (req5)
ms1718['LBXGLU']= ms1718['LBXGLU'].fillna(97)

ms1718['DIQ070'] = ms1718['DIQ070'].fillna(2)
ms1718['DIQ070'] = ms1718.DIQ070.replace({9: 2})

#CONDICIONES Y AÑADIR FILAS DE REQUISITOS

#CONDICION REQUISITO 1

condiciones_REQ1 = [((ms1718['RIAGENDR'] == 2) & (ms1718['BMXWAIST']>= 102)) | ((ms1718['RIAGENDR'] == 1) & (ms1718['BMXWAIST']>= 88)),
                     ((ms1718['RIAGENDR'] == 2) & (ms1718['BMXWAIST']< 102)) | ((ms1718['RIAGENDR'] == 1) & (ms1718['BMXWAIST']< 88)),
                    ]
                                                  
opciones_REQ1 = [1, 0]

ms1718['REQ1'] = np.select(condiciones_REQ1, opciones_REQ1)


#CONDICION REQUISITO 2

condiciones_REQ2 = [(ms1718['LBXTR'] >= 150) | (ms1718['BPQ090D'] == 1),
                     (ms1718['LBXTR'] < 150) | (ms1718['BPQ090D'] == 2) 
                    ]
                                                  
opciones_REQ2 = [1, 0]

ms1718['REQ2'] = np.select(condiciones_REQ2, opciones_REQ2)

#CONDICION REQUISITO 3

condiciones_REQ3 = [((ms1718['RIAGENDR'] == 2) & (ms1718['LBDHDD']<= 50 )) | ((ms1718['RIAGENDR'] == 1) & (ms1718['LBDHDD'] <= 40)) | (ms1718['BPQ040A'] == 1) ,
                     ((ms1718['RIAGENDR'] == 2) & (ms1718['LBDHDD']> 50)) | ((ms1718['RIAGENDR'] == 1) & (ms1718['LBDHDD'] > 40)) | (ms1718['BPQ040A'] == 2),
                    ]
                                                  
opciones_REQ3 = [1, 0]

ms1718['REQ3'] = np.select(condiciones_REQ3, opciones_REQ3)
...
condiciones_REQ4 = [(ms1718['BPXSY1'] >= 130) | (ms1718['BPXDI1'] >= 85) | (ms1718['BPQ050A'] == 1),
                     (ms1718['BPXSY1'] < 130) | (ms1718['BPXDI1'] < 85) | (ms1718['BPQ050A'] == 2)
                    ]
                                                  
opciones_REQ4 = [1, 0]

ms1718['REQ4'] = np.select(condiciones_REQ4, opciones_REQ4)

#CONDICION REQUISITO 5

condiciones_REQ5 = [(ms1718['LBXGLU'] >= 100) | (ms1718['DIQ070'] == 1),
                     (ms1718['LBXGLU'] < 100) | (ms1718['DIQ070'] == 2)
                    ]
                                                  
opciones_REQ5 = [1, 0]

ms1718['REQ5'] = np.select(condiciones_REQ5, opciones_REQ5)

#SUMA DE REQUISITOS POR FILA
ms1718['REQ_SUM'] = ms1718['REQ1'] + ms1718['REQ2'] + ms1718['REQ3'] + ms1718['REQ4'] + ms1718['REQ5']

#ENCODING METSYM 1 ES QUE TIENE Y 0 ES QUE NO
condiciones_METSYM = [(ms1718['REQ_SUM'] >= 3),
                     (ms1718['REQ_SUM'] < 3)
                    ]
                                                  
opciones_METSYM = [1, 0]

ms1718['MET_SYM'] = np.select(condiciones_METSYM, opciones_METSYM)
